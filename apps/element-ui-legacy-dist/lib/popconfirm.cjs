"use strict";
const ElPopover = require("element-ui/lib/popover");
...
const _sfc_main = {
  ...
  computed: {
    displayConfirmButtonText() {
      return this.confirmButtonText || locale.t("el.popconfirm.confirmButtonText");
    },
    displayCancelButtonText() {
      return this.cancelButtonText || locale.t("el.popconfirm.cancelButtonText");
    }
  },
  methods: {
    confirm() {
