...
const _sfc_main$1 = {
  ...
  methods: {
    ...
    modifyDateField(type, value) {
      switch (type) {
        case "hours":
          this.$emit("change", dateUtil.modifyTime(this.date, value, this.minutes, this.seconds));
          break;
        case "minutes":
          this.$emit("change", dateUtil.modifyTime(this.date, this.hours, value, this.seconds));
          break;
        case "seconds":
          this.$emit("change", dateUtil.modifyTime(this.date, this.hours, this.minutes, value));
          break;
      }
    },
...
var _sfc_render$1 = function render() {
  ...
  return _c("div", { staticClass: "el-time-spinner", class: { "has-seconds": _vm.showSeconds } }, [!_vm.arrowControl ? [_c("el-scrollbar", { ref: "hours", staticClass: "el-time-spinner__wrapper", attrs: { "wrap-style": "max-height: inherit;", "view-class": "el-time-spinner__list", "noresize": "", "tag": "ul" }, nativeOn: { "mouseenter": function($event) {
    return _vm.emitSelectRange("hours");
  }, "mousemove": function($event) {
    return _vm.adjustCurrentSpinner("hours");
  } } }, _vm._l(_vm.hoursList, function(disabled, hour) {
    return _c("li", { key: hour, staticClass: "el-time-spinner__item", class: { "active": hour === _vm.hours, "disabled": disabled }, on: { "click": function($event) {
  ...
  }), 0), _c("el-scrollbar", { ref: "minutes", staticClass: "el-time-spinner__wrapper", attrs: { "wrap-style": "max-height: inherit;", "view-class": "el-time-spinner__list", "noresize": "", "tag": "ul" }, nativeOn: { "mouseenter": function($event) {
  ...
  }), 0), _c("el-scrollbar", { directives: [{ name: "show", rawName: "v-show", value: _vm.showSeconds, expression: "showSeconds" }], ref: "seconds", staticClass: "el-time-spinner__wrapper", attrs: { "wrap-style": "max-height: inherit;", "view-class": "el-time-spinner__list", "noresize": "", "tag": "ul" }, nativeOn: { "mouseenter": function($event) {
...
exports.TimeSpinner = TimeSpinner;
