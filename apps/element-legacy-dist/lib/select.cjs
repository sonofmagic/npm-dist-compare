...
const option = require("./option-CfPYxyem.cjs");
...
const _sfc_main = {
  mixins: [emitter.emitter, locale.Locale, focus.Focus("reference"), NavigationMixin],
  name: "ElSelect",
  ...
  methods: {
    ...
    scrollToOption(option2) {
      ...
      if (this.$refs.popper && target) {
        ...
        scrollIntoView.scrollIntoView(menu, target);
      }
