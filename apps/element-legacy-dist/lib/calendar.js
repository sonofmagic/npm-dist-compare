...
import { t as range, a as getFirstDayOfMonth, C as getPrevMonthLastDays, D as getMonthDays, E as fecha, F as getI18nSettings, G as validateRangeInOneMonth } from "./date-util-CGIytBht.js";
...
const _sfc_main = {
    ...
    range: {
      ...
      validator(range2) {
        if (Array.isArray(range2)) {
          return range2.length === 2 && range2.every(
  ...
  computed: {
    ...
    validatedRange() {
      let range2 = this.range;
      if (!range2) return [];
      range2 = range2.reduce((prev, val, index) => {
...
var _sfc_render = function render() {
  ...
  } } }, [_vm._v(" " + _vm._s(_vm.t("el.datepicker.nextMonth")) + " ")])], 1)], 1) : _vm._e()]), _vm.validatedRange.length === 0 ? _c("div", { key: "no-range", staticClass: "el-calendar__body" }, [_c("date-table", { attrs: { "date": _vm.date, "selected-day": _vm.realSelectedDay, "first-day-of-week": _vm.realFirstDayOfWeek }, on: { "pick": _vm.pickDay } })], 1) : _c("div", { key: "has-range", staticClass: "el-calendar__body" }, _vm._l(_vm.validatedRange, function(range2, index) {
    return _c("date-table", { key: index, attrs: { "date": range2[0], "selected-day": _vm.realSelectedDay, "range": range2, "hide-header": index !== 0, "first-day-of-week": _vm.realFirstDayOfWeek }, on: { "pick": _vm.pickDay } });
  }), 1)]);
};
...
_Calendar.install = function install(Vue) {
