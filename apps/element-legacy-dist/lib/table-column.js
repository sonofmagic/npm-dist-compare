...
import "vue";
import { h as getPropByPath } from "./util-_v-3H2Ts.js";
import { m as mergeOptions, h as compose, i as parseMinWidth, j as parseWidth } from "./util-DxFCAhAR.js";
    ...
    setColumnRenders(column) {
      ...
      if (column.type === "expand") {
        ...
        column.renderCell = (h, data) => {
          ...
          return h("div", _mergeJSXProps2([{}, props]), [prefix, children]);
        };
      }
      return column;
    },
...
const _ElTableColumn = ElTableColumn;
_ElTableColumn.install = function install(Vue) {
  Vue.component(_ElTableColumn.name, _ElTableColumn);
};
export {
  _ElTableColumn as default
};
