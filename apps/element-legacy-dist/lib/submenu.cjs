"use strict";
require("vue");
const collapseTransition = require("./collapse-transition-0NM7WWTU.cjs");
...
const poperMixins = {
  props: {
    ...
    popperOptions: vuePopper.Popper.props.popperOptions
  },
  data: vuePopper.Popper.data,
  methods: vuePopper.Popper.methods,
  beforeDestroy: vuePopper.Popper.beforeDestroy,
  deactivated: vuePopper.Popper.deactivated
};
const _sfc_main = {
  name: "ElSubmenu",
  componentName: "ElSubmenu",
  mixins: [menuMixin.Menu, emitter.emitter, poperMixins],
  components: {
    ElCollapseTransition: collapseTransition.CollapseTransition
  },
  props: {
    index: {
      type: String,
...
const _ElSubmenu = ElSubmenu;
_ElSubmenu.install = function install(Vue) {
  Vue.component(_ElSubmenu.name, _ElSubmenu);
};
module.exports = _ElSubmenu;
