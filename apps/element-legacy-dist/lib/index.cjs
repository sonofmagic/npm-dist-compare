...
const datePickerV2 = require("./date-picker-v2.cjs");
...
const main$1 = require("./main-BqFvfS1J.cjs");
...
const main$2 = require("./main-COanY1wo.cjs");
...
const index = {
  ...
  i18n: locale.i18n,
  install,
  CollapseTransition: collapseTransition.CollapseTransition,
  Loading: loading,
...
exports.CollapseTransition = collapseTransition.CollapseTransition;
