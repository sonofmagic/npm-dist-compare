...
import { C as Clickoutside } from "./clickoutside-DF0s_YdI.js";
import { g as getWeekNumber, n as nextDate, i as isDate, p as prevDate, a as getFirstDayOfMonth, b as getDayCountOfMonth, c as getStartDateOfMonth, d as clearTime, m as modifyTime, z as getRangeMinutes, A as getRangeHours, x as clearMilliseconds, B as limitTimeRange, v as timeWithinRange, q as formatDate, e as prevMonth, f as prevYear, h as nextMonth, j as nextYear, k as modifyWithTimeString, l as parseDate, o as modifyDate, r as extractDateFormat, s as extractTimeFormat, t as range, u as getDayCountOfYear, w as changeYearMonthAndClampDate, y as isDateObject } from "./date-util-CGIytBht.js";
import { j as coerceTruthyValueToArray, d as arrayFind, f as arrayFindIndex } from "./util-_v-3H2Ts.js";
...
import { h as hasClass } from "./dom-5kqU03Ls.js";
import { e as emitter } from "./emitter-4-51d8br.js";
import { m as merge } from "./merge-B0EzIJjn.js";
import { P as Popper } from "./vue-popper-Dq_f77bl.js";
...
const _sfc_main$7 = {
  ...
  methods: {
    ...
    modifyDateField(type, value, emitSource) {
      let nextDate2 = this.date;
      switch (type) {
        case "hours":
          nextDate2 = modifyTime(this.date, value, this.minutes, this.seconds);
          break;
        case "minutes":
          nextDate2 = modifyTime(this.date, this.hours, value, this.seconds);
          break;
        case "seconds":
          nextDate2 = modifyTime(this.date, this.hours, this.minutes, value);
          break;
      }
      this.$emit("change", nextDate2, emitSource);
    },
...
const _sfc_main$6 = {
  ...
  computed: {
    ...
    displayedTime() {
      return isDate(this.date) ? formatDate(this.date, this.format || "HH:mm:ss") : "";
    }
  },
  watch: {
    visible(val) {
    ...
    value(newVal) {
      ...
      if (newVal instanceof Date) {
        ...
        date = this.defaultValue ? new Date(this.defaultValue) : clearTime(/* @__PURE__ */ new Date());
      }
      this.date = date;
...
const _sfc_main$2 = {
  ...
  data() {
    return {
      popperClass: "",
      date: clearTime(/* @__PURE__ */ new Date()),
      value: "",
      defaultValue: null,
  ...
  watch: {
    ...
    defaultValue(val) {
      if (!isDate(this.value)) {
        this.date = val ? new Date(val) : clearTime(/* @__PURE__ */ new Date());
      }
    },
  ...
  methods: {
    ...
    handleTimePick(value, visible, source) {
      if (isDate(value)) {
        ...
        const defaulted = !this.value && this.defaultTime ? modifyWithTimeString(base, this.defaultTime) : base;
    ...
    getDefaultValue() {
      return this.defaultValue ? new Date(this.defaultValue) : clearTime(/* @__PURE__ */ new Date());
    },
...
const TYPE_VALUE_RESOLVER_MAP = {
  ...
  dates: {
    ...
    parser(value, format) {
      return (typeof value === "string" ? value.split(", ") : value).map((date) => isDateObject(date) ? date : DATE_PARSER(date, format));
    }
  },
  months: {
    formatter(value, format) {
...
function valueEquals(a, b) {
  const dateEquals = function(a2, b2) {
    const aIsDate = isDateObject(a2);
    const bIsDate = isDateObject(b2);
    if (aIsDate && bIsDate) {
...
const DatePickerV2 = defineComponent({
  name: "ElDatePickerV2",
  mixins: [Picker],
  props: {
    type: {
