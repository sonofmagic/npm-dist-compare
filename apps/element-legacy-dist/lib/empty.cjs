...
const ImgEmpty = __component__$1.exports;
const _sfc_main = {
  name: "ElEmpty",
  components: {
  ...
  computed: {
    emptyDescription() {
      return this.description || locale.t("el.empty.description");
    },
    imageStyle() {
      return {
...
var _sfc_render = function render2() {
  var _vm = this, _c = _vm._self._c;
  return _c("div", { staticClass: "el-empty" }, [_c("div", { staticClass: "el-empty__image", style: _vm.imageStyle }, [_vm.image ? _c("img", { attrs: { "src": _vm.image, "ondragstart": "return false" } }) : _vm._t("image", function() {
    return [_c("img-empty")];
  })], 2), _c("div", { staticClass: "el-empty__description" }, [_vm.$slots.description ? _vm._t("description") : _c("p", [_vm._v(_vm._s(_vm.emptyDescription))])], 2), _vm.$slots.default ? _c("div", { staticClass: "el-empty__bottom" }, [_vm._t("default")], 2) : _vm._e()]);
};
...
const Empty = __component__.exports;
const _Empty = Empty;
_Empty.install = function install(Vue) {
