...
import { d as debounce, t as throttle } from "./index-Bo3IDZj6.js";
...
import { g as getKeysMap, a as getRowIdentity, t as toggleRowStatus, w as walkTreeNode, b as getColumnByKey, c as getColumnById, o as orderBy, p as parseHeight, d as getCell, e as getColumnByCell, f as objectEquals } from "./util-DxFCAhAR.js";
import { d as arrayFind, f as arrayFindIndex } from "./util-_v-3H2Ts.js";
import { s as scrollbarWidth } from "./scrollbar-width-DBGsBGf6.js";
import { h as hasClass, g as getStyle, r as removeClass, a as addClass } from "./dom-5kqU03Ls.js";
...
Watcher.prototype.mutations = {
  ...
  sort(states, options) {
    ...
    if (prop) {
      const column = arrayFind(states.columns, (column2) => column2.property === prop);
      if (column) {
        column.order = order;
...
const TableBody = {
  ...
  render(h2) {
    ...
    }, [h2("colgroup", [this.columns.map((column) => h2("col", {
      "attrs": {
        "name": column.id
      },
      "key": column.id
    }))]), h2("tbody", [data.reduce((acc, row) => {
...
const TableHeader = {
  ...
  render(h2) {
    ...
    }, [this._l(columnRows, (columns, rowIndex) => h2("tr", {
      "style": this.getHeaderRowStyle(rowIndex),
      "class": this.getHeaderRowClass(rowIndex)
    }, [columns.map((column, cellIndex) => h2("th", {
      "attrs": {
    ...
    }, [column.renderHeader ? column.renderHeader.call(this._renderProxy, h2, {
      column,
      $index: cellIndex,
      store: this.store,
      _self: this.$parent.$vnode.context
    }) : column.label, column.sortable ? h2("span", {
      "class": "caret-wrapper",
      "on": {
...
const TableFooter = {
  ...
  render(h2) {
    ...
    }, [h2("tr", [this.columns.map((column, cellIndex) => h2("td", {
      "key": cellIndex,
      "attrs": {
        "colspan": column.colSpan,
        "rowspan": column.rowSpan
    ...
    }, [sums[cellIndex]])])), this.hasGutter ? h2("th", {
      "class": "el-table__cell gutter"
    }) : ""])])]);
  },
  props: {
...
const _ElTable = ElTable;
_ElTable.install = function install(Vue2) {
  Vue2.component(_ElTable.name, _ElTable);
};
export {
  _ElTable as default
};
