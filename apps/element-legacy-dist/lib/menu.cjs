...
SubMenu.prototype.addListeners = function() {
  const keys = ariaUtils.AriaUtils.keys;
    ...
    el.addEventListener("keydown", (event) => {
      ...
      switch (event.keyCode) {
        ...
        case keys.up:
          ...
          break;
        case keys.tab:
          ariaUtils.AriaUtils.triggerEvent(parentNode, "mouseleave");
          break;
        case keys.enter:
        case keys.space:
          prevDef = true;
...
MenuItem.prototype.addListeners = function() {
  ...
  this.domNode.addEventListener("keydown", (event) => {
    ...
    switch (event.keyCode) {
      case keys.down:
        ariaUtils.AriaUtils.triggerEvent(event.currentTarget, "mouseenter");
      ...
      case keys.up:
        ...
        break;
      case keys.tab:
        ariaUtils.AriaUtils.triggerEvent(event.currentTarget, "mouseleave");
        break;
      case keys.enter:
      case keys.space:
        prevDef = true;
