...
<template>
  ...
  >
    <div
      v-show="visible"
      class="el-time-range-picker-v2 el-picker-panel el-popper"
      :class="popperClass"
    >
      <div class="el-time-range-picker-v2__content">
        <div class="el-time-range-picker-v2__cell">
          <div class="el-time-range-picker-v2__header">
            {{ t('el.datepicker.startTime') }}
          </div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="el-time-range-picker-v2__body el-time-panel-v2__content"
          >
            <TimeSpinner
              ref="minSpinner"
      ...
      <div class="el-time-panel-v2__footer">
        ...
        <button
          type="button"
          class="el-time-panel-v2__btn confirm"
